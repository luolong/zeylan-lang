...
@Command(
    name = "repl",
    description = "Opens a new Zeylan language REPL session.",
...
public final class ReplCommand implements Callable<Integer> {
    ...
    private String welcomeBanner() {
        StringBuilder out = new StringBuilder("Welcome to Zeylan language REPL session\n");
        for (var versionLine : new ZeylanCommand().getVersion()) {
